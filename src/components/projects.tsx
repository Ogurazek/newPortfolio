...
export function FeaturedProject({ title, title2, description, imgUrl, urlIcons }: Props) {
    return (
        <div
...
export function FeaturedProjectRight({ title, title2, description, imgUrl, urlIcons }: Props) {
    return (
        <div
